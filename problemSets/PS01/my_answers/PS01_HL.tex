...
\begin{document}
	...
	\lstinputlisting[language=R, firstline=38, lastline=38]{PS01_HL.R}  
	...
	\begin{enumerate}
		...
		\lstinputlisting[language=R, firstline=40, lastline=58]{PS01_HL.R} 
	...
	\lstinputlisting[language=R, firstline=61, lastline=64]{PS01_HL.R}
	...
	\begin{itemize}
		...
		\vspace{.5cm}
		\lstinputlisting[language=R, firstline=78, lastline=86]{PS01_HL.R}
  ...
  \begin{figure}[H]
   ...
   \end{figure}
	...
	\newpage
		...
		\vspace{.5cm}
		\lstinputlisting[language=R, firstline=94, lastline=110]{PS01_HL.R}
		\vspace{.2cm}
	  ...
	  \vspace{.2cm}
	  To compare the expenditure across four regions  \textbf{averagely},means of expenditure(Y) should be calculated and displayed on the plot.\\
	  Figure \ref{fig:plot_2} shows: of the four regions, the \textbf{West} exhibits the highest expenditure: its median (black line) and mean(blue point) are both the highest.Therefore, it is reasonable to conclude that on average,the West region has the highest level of expenditure.
	...
	\newpage
		...
		\lstinputlisting[language=R, firstline=114, lastline=120]{PS01_HL.R}
		...
		\lstinputlisting[language=R, firstline=123, lastline=131]{PS01_HL.R}
