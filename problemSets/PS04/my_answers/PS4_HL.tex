...
\begin{document}
	...
	\begin{enumerate}
		...
		\vspace{.3cm}
		The coefficient 0.00317 indicates: for non-professionals (the baseline), one unit increase in income is associated with an average increase of 0.00317 points in the Pineo-Porter prestige score.
