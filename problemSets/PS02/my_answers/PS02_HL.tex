...
\begin{document}
	...
	\begin{enumerate}
		...
		\lstinputlisting[language=R, firstline=2, lastline=28]{PS02_HL.R}
		...
		The R code lines are as below:
		\lstinputlisting[language=R, firstline=31, lastline=34]{PS02_HL.R}
		...
		\lstinputlisting[language=R, firstline=36, lastline=38]{PS02_HL.R}
		\begin{table}[H]
			\centering
			\begin{tabular}{l | c c c }
				& Not Stopped & Bribe requested & Stopped/given warning \\ \\[-1.8ex] \hline \\[-1.8ex]
	...
	\begin{enumerate}
		...
		\lstinputlisting[language=R, firstline=40, lastline=52]{PS02_HL.R}\\
