  ...
  \begin{figure}[H]
   ...
   \end{figure}
	...
	\newpage
		...
		\vspace{.5cm}
		\lstinputlisting[language=R, firstline=94, lastline=105]{PS01_HL.R}
		\vspace{.2cm}
	  ...
	  \vspace{.2cm}
	  Figure \ref{fig:plot_2} shows: of the four regions, the \textbf{West} exhibits the highest expenditure: its median line (black line) is the highest, the overall position of the box is higher, and the maximum value is also the largest. Therefore, it is reasonable to conclude that the West region has the highest level of expenditure.
	...
	\newpage
		...
		\lstinputlisting[language=R, firstline=109, lastline=115]{PS01_HL.R}
		...
		\lstinputlisting[language=R, firstline=118, lastline=126]{PS01_HL.R}
